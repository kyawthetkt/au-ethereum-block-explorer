    ...
    <div className="max-w-6xl mx-auto mt-10 p-6 bg-white rounded-xl shadow-md">
      <div className="flex items-center justify-between mb-20">
        {metadata ? (
          <>
            <div>
              <h6 className="text-xs mb-2">{metadata?.tokenType === "NO_SUPPORTED_NFT_STANDARD"? "ERC20": metadata?.tokenType } Contract</h6>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
              ...
              {nfts?.map((nft, index) => (
                <div key={index} className="bg-white p-2 rounded shadow-md">
                  ...
                  <h1 className="text-sm mb-1">{nft.contract.name}</h1>
              ...
              <table className="divide-y divide-gray-200 w-full">
                <tbody className="divide-y divide-gray-200">
                  ...
                  {owners.map((owner, key) => (
                    <tr key={key}>
                      <td className="px-6 py-4 text-sm">
                        <a className="text-blue-500" href={`/address/${owner}`}>
                          {owner}
                        </a>
                      </td>
                    </tr>
